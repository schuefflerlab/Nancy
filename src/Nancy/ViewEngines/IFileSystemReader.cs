namespace Nancy.ViewEngines
{
    ...
    public interface IFileSystemReader
    {
        ...
        /// <param name="excludePaths">Paths where the views should not be looked for (e.g. large data folders).</param>
        ...
        IEnumerable<Tuple<string, Func<StreamReader>>> GetViewsWithSupportedExtensions(string path, string[] excludePaths, IEnumerable<string> supportedViewExtensions);
